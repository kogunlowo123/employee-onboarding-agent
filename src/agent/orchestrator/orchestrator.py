"""Employee Onboarding Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Employee Onboarding Agent through a multi-step pipeline.
